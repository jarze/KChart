...
extension CGFloat {
//    public func toPercentFormat() -> CGFloat {
//        return CGFloat(Double(String(format: "%.2f", self))!)
//    }
    
    public func toDeciFormat(_ num: Int = 0) -> CGFloat {
        let sc = CGFloat((pow(10.0, num) as NSDecimalNumber).floatValue)
        return CGFloat(Int(self * sc)) / sc
    }
}

//extension Int {
//    public func toDateFormate(_ format: String) -> String{
//        if (String(self).count == 10) {
////            NSDadate = NSDate.init(timeIntervalSince1970: self)
//        }
//        return ""
//    }
//}
